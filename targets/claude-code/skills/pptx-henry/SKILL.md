---
name: pptx-henry
description: Create, edit, and review PowerPoint presentations using Henry's approved color palettes, semantic theme tokens, monospaced typography, and visual QA workflow. Use for any deck, slide, presentation, or .pptx task Henry asks for — it overrides the generic pptx skill's palette and font suggestions, especially when choosing colors or themes.
---
...
prefer Henry's deck-builder MCP server (mcp-deck) over this skill.
...
```js
const { THEMES } = require("/path/to/pptx-henry/assets/theme-tokens.js");
