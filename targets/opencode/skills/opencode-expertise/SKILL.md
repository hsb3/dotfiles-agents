...
description:
  ...
  or migrating extenders for it, designing the opencode distribution target in
  dotfiles-agents, or answering how any opencode surface works.
metadata:
  version: 0.2.0
  verified: 2026-07-02
---
...
- **Hooks → NOT mechanical, currently deferred.** The dotfiles-agents capability matrix marks
...
- `references/cc-to-opencode-mapping.md` — the full translation table (feeds the
  dotfiles-agents translation service).
