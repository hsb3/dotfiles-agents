# Distributing dotfiles-agents bundles to opencode

_How the `targets/opencode` output of the translation pipeline should be laid out and
installed. ✅ = verified against https://opencode.ai/docs 2026-07-02._
