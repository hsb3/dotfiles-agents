...
Distilled from an HTML deck-server playbook. These rules
...
## Explanatory Register (the confirmed preference)
...
- **More slides beats denser slides.** When asked for comprehensive,
...
- **Spell out references.** An issue/ticket number always gets its title
  inline ("#NN — the concrete change this milestone lands"), never a bare
