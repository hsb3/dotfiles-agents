...
Ships 23 skills (verbatim; opencode also reads `.claude/skills/` natively — this lane is the explicit, deterministic copy) and 4 agents (frontmatter remapped: `mode: subagent`, provider-prefixed models, CC tool allowlists inverted to permission maps).

## Not in this lane (and why)

| Primitive | Type | Reason |
|---|---|---|
| `claude-code-config` | skill | roster targets do not include opencode |
...
| `tech-eval-research` | skill | roster targets do not include opencode |
