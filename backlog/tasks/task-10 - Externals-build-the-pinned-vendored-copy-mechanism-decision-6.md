...
- [ ] #2 ADR 0015 amended to permit `origin: vendored` under docs/vendoring-rule.md, citing it
- [ ] #3 Roster schema + check_provenance gain the vendored arm (upstream + immutable SHA + LICENSE + attribution enforced)
- [ ] #4 The 4 install-from-upstream plugin externals dropped from the roster/externals.yaml
- [ ] #5 pptx-themes/base reclassified `origin: vendored` and passes the new arm
- [ ] #6 make ci green (drift guards clean under the amended rules)
<!-- AC:END -->
