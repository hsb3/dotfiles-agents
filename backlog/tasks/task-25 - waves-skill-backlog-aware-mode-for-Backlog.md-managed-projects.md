...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 The skill states which of the two shapes it is — a mode inside waves, or a separate successor skill — and the choice is justified in one sentence rather than left open
...
- [ ] #3 All backlog reads and writes go through the backlog CLI, never by editing task markdown directly, per the owner ruling recorded in decision-7
