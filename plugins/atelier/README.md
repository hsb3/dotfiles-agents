...
Its `codex-setup` command reconciles policy placement and project sandbox writable roots. A root someone added after atelier's own in its managed `writable_roots` block survives a rewrite of that block and is named as kept.
