...
Its `codex-setup` command reconciles policy placement and project sandbox writable roots. A root someone added inside atelier's managed `writable_roots` block survives a rerun and is named as kept.
