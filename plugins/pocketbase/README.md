...
The bundled shared hook library includes Atelier's Codex session-handoff transaction helper and
guarded nested-worktree retirement notice. PocketBase's own hooks activate neither policy.
