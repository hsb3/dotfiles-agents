...
- **NEXT (in order of readiness):** (a) **owner court — EDB-24**: gaps/partials all have
  in-estate candidates (promote user-level deep-research / dataviz / update-config;
  fold migrate-at-scale playbook into foreman-kit; reference claude-in-chrome) — which get
  rostered feeds M3; (b) **M4 EDB-21** formalize judge+rubric+CaseScore — the M1 boundary
