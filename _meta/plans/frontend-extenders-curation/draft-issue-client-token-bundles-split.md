---
title: "refactor: split the three client-token frontend bundles -- capability out, tokens to client store"
type: proposed-issue
status: draft
created: 2026-07-12
purpose: Staged refactor issue from the #48 curation plan (ruling 48.4 + the wb#25 split precedent).
