...
- [kata sync enable resets the cursor](kata-sync-enable-resets-cursor.md) — re-enabling the GitHub binding re-applies every GitHub title/body/status/priority onto the board; snapshot first, restore by script, close mirrors with cards
