...
- **dev-tooling-desk** (`~/Documents/EXECUTIVE_DESK/Projects/dev-tooling-desk`) — the exec-desk instance: planning surface, `_knowledge/extenders.yaml` census, live `pb_data/`, decisions 0001–0021.
