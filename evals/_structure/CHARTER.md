...
- **Store:** One private Railway-hosted PocketBase is the operational source for CLI clients.
  ...
  `pb_data/` is untracked and ignored after verified migration and hosted backup/restore;
  private local backup or fixture bytes may remain. Schema, ingest, and seeds
