...
FRAMEWORKS = [
    ...
    },
    {
        ...
        "status": "active",
        "summary": "This repo's manifest schema (primitives-core.yaml): id/type/source/shelf/origin/disposition/targets/plugins/requires, with origin:sourced and origin:vendored requiring upstream+ref. Enforced by scripts/check_roster.py.",
        "elements": [
            ("shelf", "shelf", "dimension", "core vs toggle shelving.", "Roster entry carries shelf."),
            ("origin-provenance", "origin provenance", "rule", "authored vs sourced vs vendored is immutable; sourced and vendored require non-null upstream+ref.", "origin:sourced and origin:vendored entries have upstream and ref."),
            ("disposition", "disposition", "dimension", "qualified | grandfathered-pending-use | demoted | untriaged | orphaned.", "Roster entry carries disposition."),
