...
On the same sources, when no activation file resolves, it also says `atelier is enabled here but
not activated: every enforcing hook is off; run /atelier:activate`, ahead of any handoff excerpt.
