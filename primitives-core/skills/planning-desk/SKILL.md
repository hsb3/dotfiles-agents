...
- **Distribution.** The skill ships inside the `mise-en-place` bundle from the `dotfiles-agents`
  marketplace; a consuming repo turns it on with `claude plugin enable mise-en-place@dotfiles-agents`
