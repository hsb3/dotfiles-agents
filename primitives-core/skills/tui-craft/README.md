...
inheriting one you didn't write, or debugging a specific symptom: flicker, tearing, resize
corruption, broken copy-paste, terminal state left wrong after exit or crash, or slow output
with long content. It also triggers on any TUI framework or terminal primitive by name
(Textual, Rich, Ratatui, crossterm, Bubble Tea, Lipgloss, OpenTUI, Ink, prompt_toolkit,
curses, notcurses, tview, blessed, alternate screen, raw mode, ANSI escapes). Not for
ordinary CLI work or browser-based terminal emulators.
